...
export default function Projects({ t }: ProjectsProps) {
  return (
    <motion.section id={ANCHORS.projects} className="section-padding bg-cream dark:bg-noir" {...fadeInUp}>
          ...
          <SwiperSlide key={index} className="h-auto">
            <div className="project-card group">
              <div className="relative h-48 shrink-0 overflow-hidden">
                ...
                <span className="absolute top-4 left-4 font-mono text-[10px] tracking-widest uppercase bg-gold text-ink px-2.5 py-1 rounded-full">
                  {project.cost}
                </span>
              </div>
              <div className="flex flex-1 flex-col p-6">
                <h3 className="mb-2 text-xl font-display font-semibold text-forest dark:text-cream">
                  {project.title}
                </h3>
                <p className="mb-5 flex-1 text-sm leading-relaxed text-ink/60 dark:text-cream/50">
                  {project.description}
                </p>
                <div className="mb-5">
                  ...
                  <div className="mt-2 flex justify-between">
                    <span className="font-mono text-xs text-ink/50 dark:text-cream/40">
