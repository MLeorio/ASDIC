...
export default function Timeline({ t }: TimelineProps) {
  ...
  return (
    <section id="actions" className="section-padding bg-white dark:bg-noir-surface">
      <motion.div {...fadeInUp} className="max-w-5xl mx-auto mb-16 flex items-end justify-between flex-wrap gap-4">
        <div>
          ...
          <h2 className="text-3xl md:text-5xl font-display font-semibold mt-3 text-forest dark:text-cream">
            {t('timelineTitle')}
          </h2>
        </div>
      </motion.div>
            ...
            return (
              ...
              >
                <div
                  ...
                  } top-1/2 -translate-y-1/2 w-9 h-9 rounded-full bg-cream dark:bg-noir border-2 ${
                ...
                <motion.div
                  ...
                  className={`group flex gap-5 items-start bg-cream dark:bg-noir p-6 md:p-7 rounded-2xl border border-ink/5 dark:border-white/10
                ...
                >
                  ...
                  <div>
                    ...
                    <h3 className="text-lg md:text-xl font-display font-semibold mt-2 text-forest dark:text-cream">
                      {item.title}
                    </h3>
                    <p className="mt-2 text-ink/60 dark:text-cream/50 text-sm md:text-base">{item.description}</p>
                  </div>
                </motion.div>
              </motion.div>
            );
